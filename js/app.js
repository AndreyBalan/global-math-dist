(() => {
    ...
    (() => {
        ...
        shareLinks.forEach((link => {
            link.addEventListener("click", (function(event) {
                ...
                switch (socialNetwork) {
                  case "facebook":
                    window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(pageUrl)}&title=${encodeURIComponent(document.title)}&summary=&source=`);
                    break;

                  case "twitter":
                    window.open(`https://twitter.com/share?url=${encodeURIComponent(pageUrl)}&title=${encodeURIComponent(document.title)}&summary=&source=`);
                    break;

                  case "pinterest":
                    window.open(`http://pinterest.com/pin/create/button/?url=${encodeURIComponent(pageUrl)}&title=${encodeURIComponent(document.title)}&summary=&source=`);
                    break;

                  case "linkedin":
                    window.open(`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(pageUrl)}&title=${encodeURIComponent(document.title)}&summary=&source=`);
                    break;
                }
            }));
        }));
        let siteIndex = [ {
            ...
            url: "../free-advertising.html"
        }, {
            title: "9 simple ways to improve your design skills",
            url: "../improve-design-skills.html"
        }, {
            title: "Tips to quickly improve your coding speed.",
            url: "../coding-speed-tips.html"
        }, {
            ...
            title: "Mastering SEO: A Guide for Beginners",
            url: "../seo-guide.html"
        } ];
        let searchInput = document.querySelector("#site-search");
        let resultsContainer = document.querySelector("#search-results");
        if (searchInput && resultsContainer) searchInput.addEventListener("input", (function(e) {
        ...
        })); else console.log("Search input or results container not found");
        window["FLS"] = true;
        menuInit();
        formFieldsInit({
            viewPass: false,
